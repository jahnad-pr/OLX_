...
export default function UserDetails({setDetShow}) {
  ...
  return (
    ...
    after:absolute after:w-0 after:h-0 after:border-l-[10px] after:border-r-[10px] after:border--transparent after:border-r-transparent after:border-b-[10px] after:border-b-white after:border-l-transparent  after:right-[22%] after:top-[-10px] '>
        ...
        <button className='h-10 w-[calc(100%_-_48px)] bg-black my-4 mx-6 text-white flex items-center justify-center rounded-md'>You can only view</button>
        <div className='m-6'>
        ...
        <div className="border-t-2 border-gray-200 w-full">
            <ul className='w-[100%]'>
                <li className='h-[48px] px-6 py-3 flex items-center gap-4'>
        ...
        <div className="border-t-2 border-gray-200 w-full">
            <ul className='w-[100%]'>
                ...
                <li onClick={()=>{ signOutUser(),setDetShow(false) }} className='h-[48px] px-6 pb-6 py-3 flex items-center gap-4'>
