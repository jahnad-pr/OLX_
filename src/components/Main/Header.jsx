...
export default function Header({ setLogPop }) {
  ...
  const sellProdect = () => makeSell(true)
    ...
    <>
      <div onClick={closeAll} className='min-h-18 marker w-[100vw]  px-[10px] md:py-1 overflow-hidden bg-[#eff1f3]'>
        <div className="inner w-full flex gap-[5px] md:gap-5 items-center m-auto flex-wrap py-2 pr-3">
          ...
          <div className=' flex-1 md:flex'>
            ...
            <div className='flex flex-1 min-w-[calc(100vw_-_20px)] ml-0 md:min-w-0 md:ml-4' >
              ...
              <div className='flex-1 md:h-12 h-10 border-solid border-2 border-slate-950 rounded-md w-full md:rounded-r-none flex items-center gap-3 px-2 focus-within:border-[#47e7df]' type="text" >
                <svg width="25px" height="25px" viewBox="0 0 1024 1024" data-aut-id="icon" className="md:hidden" fillRule="evenodd"><path className="rui-w4DG7" d="M448 725.333c-152.917 0-277.333-124.416-277.333-277.333s124.416-277.333 277.333-277.333c152.917 0 277.333 124.416 277.333 277.333s-124.416 277.333-277.333 277.333v0zM884.437 824.107v0.021l-151.915-151.936c48.768-61.781 78.144-139.541 78.144-224.192 0-199.979-162.688-362.667-362.667-362.667s-362.667 162.688-362.667 362.667c0 199.979 162.688 362.667 362.667 362.667 84.629 0 162.411-29.376 224.171-78.144l206.144 206.144h60.352v-60.331l-54.229-54.229z"></path></svg>
                <input value={searchData} onChange={(evt) => { setSD(evt.target.value) }} placeholder='Find Cars, Mobile Phones and more...' className='w-[100%] bg-transparent outline-none' type="text" />
              </div>
              <svg width="50px" height="50px" viewBox="0 0 1024 1024" data-aut-id="icon" className="p-3 md:h-12 fill-white bg-black rounded-r-md hidden md:block" fillRule="evenodd"><path className="rui-o3KKi" d="M448 725.333c-152.917 0-277.333-124.416-277.333-277.333s124.416-277.333 277.333-277.333c152.917 0 277.333 124.416 277.333 277.333s-124.416 277.333-277.333 277.333v0zM884.437 824.107v0.021l-151.915-151.936c48.768-61.781 78.144-139.541 78.144-224.192 0-199.979-162.688-362.667-362.667-362.667s-362.667 162.688-362.667 362.667c0 199.979 162.688 362.667 362.667 362.667 84.629 0 162.411-29.376 224.171-78.144l206.144 206.144h60.352v-60.331l-54.229-54.229z"></path></svg>
              <div></div>
            </div>
          </div>
          ...
          <div className='md:flex min-w-25 hidden gap-2 text-[14px]'>
            <p>ENGLISH</p>
            <svg onClick={() => setLangShow(!langShow)} width="24px" height="24px" viewBox="0 0 1024 1024" data-aut-id="icon" className={`${langShow ? 'rotate-180' : 'rotate-0'} duration-500`} fillRule="evenodd"><path className="rui-w4DG7" d="M85.392 277.333h60.331l366.336 366.336 366.336-366.336h60.331v60.331l-408.981 409.003h-35.307l-409.045-409.003z"></path></svg>
          </div>
          <span className='block flex-1 md:hidden'></span>
          {!isSign ? <p onClick={() => { setLogPop(true) }} className='hidden md:block'>Login</p> :
            <>
